"""
Django settings for vacant project.
...
SECRET_KEY = 'ap-=#u=e^#h%r%+6rd^#l1mldqxcob26qyz)dc#^e+lu8)kbb$'
...
WSGI_APPLICATION = 'vacant.wsgi.application'
